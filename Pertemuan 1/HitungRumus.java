...
public class HitungRumus{
	...
	int menu;
        ...
        do{
            ...
            System.out.println("===========================================");
            System.out.println("SELAMAT DATANG DI MENU PEMILIHAN RUMUS");
            System.out.println("======================================");
    ...
    private static void waktu() {
        double v, s, t, hasil;
        Scanner sc = new Scanner(System.in);
        System.out.println("Silahkan Masukkan jarak(dalam satuan Km) ");
        s = sc.nextDouble();
        System.out.println("Silahkan Masukkan kecepatan (dalam satuan Km/jam)");
        v = sc.nextDouble();
        hasil = s/v;
    ...
    private static void jarak() {
        ...
        System.out.println("Silahkan Masukkan Kecepatan (dalam satuan Km/jam) ");
        v = sc.nextDouble();
        System.out.println("Silahkan Masukkan waktu (dalam satuan jam)");
        t = sc.nextDouble();
        hasil = v*t;
